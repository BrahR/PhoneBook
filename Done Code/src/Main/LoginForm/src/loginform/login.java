...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(SignUp, new org.netbeans.lib.awtextra.AbsoluteConstraints(252, 360, 70, 20));
            ...
            if (use.isValidPassword(filledPassword)) {
                ...
                if (conts.isValidLogin(filledEmail, filledPassword)) {
                    ...
                    JOptionPane.showMessageDialog(null,
                            ...
                            "login Faild.", JOptionPane.WARNING_MESSAGE);
                }
