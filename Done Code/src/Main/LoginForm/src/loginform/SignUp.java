...
public class SignUp extends javax.swing.JFrame {
  ...
  // <editor-fold defaultstate="collapsed" desc="Generated
    ...
    private void initComponents() {
        ...
        Enable2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8_eye_20px_1.png"))); // NOI18N
        ...
        Enable1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8_eye_20px_1.png"))); // NOI18N
  ...
  private void registerActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    if (filledPassword.equals(filledConfirmPassword)) {
        // Create a new Contact object

        if (use.validEmail(filledEmail) && use.isValidPassword(filledPassword)) {
            
            if (conts.isValidContact(filledEmail)) {
                Contact obj1 = new Contact(filledEmail,filledPassword);
                conts.addContact(obj1);

                JOptionPane.showMessageDialog(null,
                        "Please note Your ID is :" + obj1.getID(),
                ...
                JOptionPane.showMessageDialog(null,
                        "Already registered",
                        "Contact already signed up", JOptionPane.WARNING_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(null,
        ...
        JOptionPane.showMessageDialog(null,
                ...
                "Password Confirmation Error.", JOptionPane.WARNING_MESSAGE);
    }
}
