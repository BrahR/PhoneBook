...
public class NewJFrame extends javax.swing.JFrame {
  ...
  public NewJFrame(String email) {
    ...
    // row selector
    booked.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
    @Override
    public void valueChanged(ListSelectionEvent e) {
        if (!e.getValueIsAdjusting()) {
            ...
            if (selectedRow != -1) {
                ...
                String phoneValue = booked.getValueAt(selectedRow, 2).toString();
                String addressValue = booked.getValueAt(selectedRow, 3).toString();
  ...
  // <editor-fold defaultstate="collapsed" desc="Generated
    ...
    private void initComponents() {
        ...
        userDashboard.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, java.awt.Color.white, java.awt.Color.white, java.awt.Color.white, java.awt.Color.white));
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 0, 20, 20));
        ...
        jPanel1.add(Logout, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 540, -1, -1));
  ...
  private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    if (!Utils.displayError(new Validate(rowCount == 1, "Please select one row at a time", "Invalid Input"))) {
        return;
    }
    ...
    try {
        int emailId = Integer.parseInt(JOptionPane.showInputDialog("Enter your ID"));
